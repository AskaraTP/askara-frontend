...
export default function CreateProductPage() {
  ...
  // Dynamic Specs & Feature Lists
  const [specRows, setSpecRows] = useState<SpecRow[]>([
    { key: 'Throughput', value: 'Up to 200 tests/hour' },
    { key: 'Power Supply', value: '100-240V AC, 50/60Hz' },
  ]);
  const [featuresList, setFeaturesList] = useState<string[]>([
    'Fully automated pipetting and wash cycle',
  ...
  useEffect(() => {
    async function loadCategories() {
      try {
        ...
        setCategories(cats);
        if (cats.length > 0) {
          setFormData((prev) => ({ ...prev, product_category_id: cats[0].id.toString() }));
        }
      } catch (err: any) {
  ...
  const handleImageFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (result.url) {
        ...
        toast('Image successfully uploaded', 'success');
      }
    } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast(formatErrorMessage(err, 'Error creating product'), 'error');
      setSaving(false);
    }
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-6 pb-16">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-lg border border-slate-200 sticky top-4 z-20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-slate-900 leading-tight">Create New Product</h1>
              <p className="text-xs text-slate-500">Fill in details to publish a new instrument or reagent</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                placeholder="e.g. BioSystems Y15 Automatic Analyzer"
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Alat Analisis Otomatis BioSystems Y15"
                className="w-full px-3.5 py-2.5 rounded-md border border-slate-200 text-xs sm:text-sm focus:border-brand-500 focus:ring-1 focus:ring-brand-500 outline-none transition-colors"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div>
              ...
              <div className="flex gap-1.5">
                <input
                  ...
                  placeholder="biosystems-y15-analyzer"
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. BioSystems, Waters, Merck"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div>
              ...
              <textarea
                ...
                placeholder="High-throughput automatic analyzer for wine and beverage testing..."
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Penganalisis otomatis throughput tinggi untuk pengujian sampel minuman..."
                className="w-full px-3.5 py-2 rounded-md border border-slate-200 text-xs sm:text-sm focus:border-brand-500 outline-none"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div>
              ...
              <textarea
                ...
                placeholder="Comprehensive technical details about operational benefits..."
                className="w-full px-3.5 py-2 rounded-md border border-slate-200 text-xs sm:text-sm focus:border-brand-500 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Deskripsi mendalam mengenai keunggulan operasional instrumen..."
                className="w-full px-3.5 py-2 rounded-md border border-slate-200 text-xs sm:text-sm focus:border-brand-500 outline-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-2.5">
            {specRows.map((row, idx) => (
              <div key={idx} className="flex items-center gap-2.5">
                ...
                <input
                  type="text"
                  placeholder="Value / Specification Detail (e.g. 500 x 400 x 300 mm)"
                  value={row.value}
                  onChange={(e) => {
                    const next = [...specRows];
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6 space-y-5">
          <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Upload clean PNG/JPG transparent image and brochure link</p>
            </div>
          </div>
