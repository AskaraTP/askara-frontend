...
export default function CreateHeroSlidePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast('Hero banner slide created successfully', 'success');
      router.push('/admin/homepage');
    } catch (err: any) {
      toast(err.message || 'Failed to create hero slide', 'error');
    } finally {
      setSaving(false);
    }
  };
        ...
        <div className="flex items-center justify-between bg-white p-4 sm:p-5 rounded-lg border border-slate-200 shadow-xs">
          <div className="flex items-center gap-3">
            <Link
              ...
              title="Back to Homepage Banners"
            >
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Upload a high quality background image for this slide or choose from presets.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-12 gap-5 items-center">
              ...
              <div className="md:col-span-6 space-y-3">
                ...
                >
                  ...
                  {uploading ? 'Uploading Image...' : 'Upload High-Res Banner Image'}
                </button>
