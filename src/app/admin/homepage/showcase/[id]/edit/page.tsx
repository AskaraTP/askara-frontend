...
interface EditShowcaseSlidePageProps {
  params: Promise<{
    id: string;
  }>;
}

export default function EditShowcaseSlidePage({ params }: EditShowcaseSlidePageProps) {
      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 sm:p-5 rounded-lg border border-slate-200 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-slate-900">Edit Showcase Slide #{slideId}</h1>
              <p className="text-xs text-slate-500">Update showcase image asset and bilingual captions</p>
            </div>
          </div>
