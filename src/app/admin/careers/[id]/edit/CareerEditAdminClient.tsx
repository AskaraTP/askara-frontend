...
interface CareerEditAdminClientProps {
  params?: Promise<{
    id: string;
  }>;
}

export default function CareerEditAdminClient({ params }: CareerEditAdminClientProps) {
  const careerIdStr = useDynamicId(params);
