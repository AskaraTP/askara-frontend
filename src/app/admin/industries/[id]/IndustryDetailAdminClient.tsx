...
export default function IndustryDetailAdminClient({ params }: IndustryDetailPageProps) {
    ...
    return (
      <AdminLayout title="Industry Not Found">
        <div className="bg-white p-12 rounded-lg border border-slate-200 text-center space-y-4">
          ...
          <p className="text-xs text-slate-500">The industry sector with ID or slug &quot;{industryId}&quot; does not exist or has been removed.</p>
          <Link
  ...
  return (
    <AdminLayout title={`Industry: ${industry.title_id || industry.title_en}`}>
      <div className="space-y-5">
        ...
        {/* Bilingual Detailed Content Breakdown */}
        ...
        {/* Target Category & System Metadata */}
        <div className="bg-white p-5 rounded-lg border border-slate-200 shadow-xs space-y-4">
