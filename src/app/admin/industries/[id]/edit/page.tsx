      ...
      <div className="space-y-5">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 sm:p-5 rounded-lg border border-slate-200 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-slate-900">Edit Industry Sector #{industryId}</h1>
              <p className="text-xs text-slate-500">Update industry details, bilingual descriptions, and homepage settings</p>
            </div>
          </div>
